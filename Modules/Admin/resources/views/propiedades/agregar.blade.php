    ...
    const token = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
        ...
        function agregarInmueble() {
            ...
            var data = {
                ...
                // ano_construccion: $('#ano_construccion').val(),
            ...
            //alert($('#financiamiento_bancario').val());
            ...
            $.ajax({
                ...
                url: '{{ route('adm.propiedades.agregar_nuevo') }}', // La URL de la ruta en Laravel
                contentType: 'application/json',
                data: JSON.stringify(data),
                success: function(response) {
                    alert('Datos enviados con éxito');
                    console.log(response);
                    window.location.href = '{{ route('adm.subir.imagenes') }}/'+response.UltID;
                },
...
@section('content')
<h4 class="py-3 mb-4">
    <span class="text-muted fw-light">Propiedad /</span><span> Agregar</span>
</h4>
...
<div class="app-ecommerce">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
        ...
        <div class="d-flex flex-column justify-content-center">
            <h4 class="mb-1 mt-3">Agregar nueva Propiedad</h4>
        </div>
        <div class="d-flex align-content-center flex-wrap gap-3">
            <button type="button" onclick="agregarInmueble();" id="submitBtn" class="btn btn-primary">Publicar</button>
        </div>
    </div>
                    ...
                    <form id="frmAgregarInmueble">
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                            <select id="ciudad" name="ciudad" class="select2 form-select" data-placeholder="Ciudad">
                                ...
                                <option value="{{ $ciudad['nombre'] }}" @if($ciudad['nombre']=='Potosí' ) selected
                                    @endif>
                                    {{ $ciudad['nombre'] }}
                                </option>
                                @endforeach
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                            <input type="text" class="form-control" id="direccion" placeholder="Dirección"
                                name="direccion" aria-label="Dirección">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="input-group input-group-lg" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <input type="number" name="num_garajes" id="num_garajes" min="0" value="0"
                            ...
                            <div class="col">
                                <div class="input-group input-group-lg" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <input type="number" name="num_banos" id="num_banos" min="0" value="0"
                                        class="form-control" placeholder="Baños" aria-label="Baños"
                                        aria-describedby="basic-addon45">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="input-group input-group-lg" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <input type="number" name="num_dormitorios" id="num_dormitorios" min="0" value="0"
                            ...
                            <div class="col">
                                <div class="input-group input-group-lg" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <input type="number" name="num_salas" id="num_salas" min="0" value="0"
                                        class="form-control" placeholder="Salas" aria-label="Salas"
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <div class="input-group input-group-lg" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <input type="number" name="num_habitaciones" id="num_habitaciones" min="0" value="0"
                            ...
                            <div class="col">
                                <div class="input-group input-group-lg" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <input type="number" name="num_cocinas" id="num_cocinas" class="form-control"
                                        min="0" value="0" aria-describedby="basic-addon46">
                        ...
                        <div>
                            ...
                            <textarea class="form-control p-2 pt-1" id="descripcion" name="descripcion"
                                placeholder="Descripción corta de la propiedad" rows="6"></textarea>
                            ...
                            <!--div-- class="form-control">
                                ...
                                <div class="comment-editor border-0 pb-1" id="descripcion"></div>
                            </!--div-->
                        </div>
                    </form>
                </div>
                    ...
                    <form id="frmAgregarInmueble2">
                        <div class="form-floating form-floating-outline mb-4">
                            <input type="number" class="form-control" id="precio" placeholder="Precio" name="precio"
                                aria-label="Precio" min="0" value="0">
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                            <input type="number" class="form-control" min="0" id="superficie_terreno"
                                placeholder="Superifica Terreno" name="superficie_terreno"
                                aria-label="Superifica Terreno">
                            <div class="invalid-feedback" id="error-superficie_terreno"></div>
                            <label for="superficie_terreno">Superificie Terreno m²</label>
                        </div>
                        <div class="form-floating form-floating-outline mb-4">
                            <input type="number" class="form-control" min="0" id="superficie_construida"
                                placeholder="Superifica Construida" name="superficie_construida"
                                aria-label="Superifica Construida">
                    ...
                    <form id="frmAgregarInmueble3">
                        <div class="mb-4 col ecommerce-select2-dropdown d-flex justify-content-between">
                            <div class="form-floating form-floating-outline w-100 me-3">
                                ...
                                <label for="category-org">Propietario</label>
                            </div>
                            <div>
                        ...
                        <div class="mb-4 col ecommerce-select2-dropdown">
                            <div class="form-floating form-floating-outline">
                                ...
                                <label for="status-org">Estado</label>
                            </div>
                        </div>
                        <!-- Tags -->
                        {{-- <div class="mb-3">--}}
