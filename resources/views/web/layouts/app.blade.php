...
<body class="bg-smoke">
    ...
    <!--============================== Footer Area ==============================-->
    <footer id="contact" class="footer-wrapper footer-default bg-theme">
                    ...
                    <div class="col-md-6 col-xl-auto">
                        <div class="widget footer-widget">
                            <div class="th-widget-about">
                                ...
                                <p class="about-text">Soluciones Inmobiliarias: Expertos en propiedades, creamos hogares
                                    y oportunidades. Transformamos sueños en realidad con servicio personalizado e
                                    innovación inmobiliaria.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-auto">
                ...
                <div class="row gy-3 align-items-center">
                    <div class="col-lg-6">
                        <p class="copyright-text">
                            Copyright <i class="fal fa-copyright"></i> 2025 <a href="/">Soluciones Inmobiliarias</a>, Derechos
                            reservados.
                        </p>
                    </div>
                    <div class="col-lg-6">
